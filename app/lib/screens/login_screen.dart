  ...
  void _showNeedRegister() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('该手机号未注册，请先注册账号', style: TextStyle(color: AppColors.paperMid, decoration: TextDecoration.none)),
        actions: [
          ...
          TextButton(
            ...
            child: Text('去注册', style: TextStyle(color: AppColors.celadon, fontWeight: FontWeight.w600)),
          ),
        ],
      ),
    );
